...
s.source_files  = "FCXUniversial/FCXDiscover/", "FCXUniversial/FCXCategory/", "FCXUniversial/FCXUniversial/", "FCXUniversial/FCXAdvert/", "FCXUniversial/FCXShare/", "UMSocial/UMSocial_Sdk_5.0.1/Header/*.h", "UMSocial/UMSocial_Sdk_Extra_Frameworks/Wechat/*.h", "UMSocial/UMSocial_Sdk_Extra_Frameworks/TencentOpenAPI/*.h", "UMSocial/UMSocial_Sdk_Extra_Frameworks/SinaSSO/*.h", "UMOnlineConfig/"

s.resources = "FCXUniversial/FCXShare/ShareIcon/*.png", "UMSocial/**/*.{bundle,xib,.lproj}"

 s.vendored_libraries = "FCXUniversial/FCXAdvert/libGDTMobSDK.a", "UMSocial/**/*.a", "UMOnlineConfig/libUMOnlineConfig.a"
